...
// //   const handleOrbit = () => {
// //     navigation.navigate("OrbitScreen");
// //   };
...
// //         {/* First Button */}
// //         <TouchableOpacity style={styles.option} onPress={handleOrbit}>
// //           <Image source={require('./star.png')} style={styles.icon} />
// //           <Text style={styles.optionText}>For me and my orbit circle</Text>
// //         </TouchableOpacity>

// //         {/* Second Button */}
// //         <TouchableOpacity style={styles.option} onPress={handleCommunity}>
// //           <Image source={require('./star2.png')} style={styles.icon} />
// //           <Text style={styles.optionText}>For a public community space</Text>
// //         </TouchableOpacity>
// //       </View>

// //       {/* Skip */}
// //       <TouchableOpacity style={{ marginTop: 40 }} onPress={handleSkip}>

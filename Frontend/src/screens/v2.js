...
export default function OnboardingScreen({ navigation }) {
  ...
  useEffect(() => {
    ...
    // Slide left → right → reset loop
    const runSlide = () => {
      slideAnim.setValue(0);

      Animated.sequence([
        Animated.timing(slideAnim, {
          toValue: -width, // moves left (out of screen)
          duration: 2000,
        ...
        Animated.timing(slideAnim, {
          toValue: width, // jump to right side
          duration: 0,
          useNativeDriver: true,
        }),

        Animated.timing(slideAnim, {
          toValue: 0, // come back to original
          duration: 2000,
          easing: Easing.inOut(Easing.ease),
          useNativeDriver: true,
        }),
  ...
  return (
    <View style={styles.container}>
      ...
      {/* TOP LABEL  (BIGGER + absolute so it won't push images) */}
      <Image
      ...
      <Text style={styles.featureDesc}>
        Converse seamlessly with friends and teams through text, voice, and video powered by
        Ballastra AI for smarter, faster conversations.
      </Text>
...
const styles = StyleSheet.create({
  ...
  /* TOP LABEL – BIGGER + ABSOLUTE POSITION */
  welcomeLabel: {
    width: width * 0.95,
    height: height * 0.09, // Increased Size
    position: "absolute",
    top: height * 0.08,
    zIndex: 10,
  },
